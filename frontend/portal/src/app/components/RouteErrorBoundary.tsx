...
function getFriendlyMessage(error: unknown) {
  if (isRouteErrorResponse(error) && error.status === 404) {
    return {
      ...
      message: "That page could not be loaded. Please return home or visit the Help Center.",
    };
  }

  return {
    title: "Something went wrong",
    message: "This page could not be loaded. Please return home or visit the Help Center.",
  };
}
