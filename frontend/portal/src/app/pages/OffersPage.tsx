...
const offers: OfferCard[] = [
  ...
  },
  {
    ...
    desc: "Australia's leading HR, payroll, and team management platform. Run onboarding, leave management, and payroll from one dashboard.",
    badge: "Member value",
  ...
  },
  {
    ...
    desc: "Get your first contract or legal document reviewed at no cost by a specialist business law provider.",
    badge: "High Value",
  ...
  },
  {
    ...
    desc: "Teams, SharePoint, Word, Excel, Outlook, and more for businesses that need a dependable collaboration stack.",
    badge: "Popular",
    badgeColor: "bg-blue-700",
    highlight: false,
    features: [
  ...
  },
  {
    ...
    saving: "Save $80/year",
    desc: "Create professional marketing materials, pitch decks, and brand assets from one easy-to-use platform.",
    badge: "Great Value",
  ...
  },
  {
    ...
    subOffer: "Starter and Basic plans",
    saving: "Save up to $87",
    desc: "Launch or migrate your online store with a structured introductory offer on selected plans.",
    badge: "Limited Time",
    ...
    features: [
      ...
      "Admin tools for growing businesses",
    ],
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <PageHero
        ...
        ctaSecondary={{ label: "Contact us", href: "/contact?reason=offers-partnership" }}
            ...
            {filteredOffers.length === 0 ? (
              <div className="mx-auto max-w-3xl rounded-3xl border border-slate-200 bg-slate-50 px-6 py-12 text-center shadow-sm">
                ...
                <p className="mx-auto mt-4 max-w-2xl text-sm leading-7 text-slate-600">
                  Partner offers, member benefits, and limited-time opportunities will appear here as they become available.
                </p>
