      ...
      <main className="py-16 sm:py-20">
        <div className="mx-auto w-full max-w-5xl px-4 sm:px-6 lg:px-8">
          <div className="rounded-2xl border border-slate-200 bg-white p-8 sm:p-10 shadow-sm">
            ...
            <h1 className="text-3xl font-black tracking-tight text-slate-900 sm:text-4xl">Membership Usage</h1>
            <p className="mt-4 max-w-3xl text-slate-600">Placeholder guidance on how members can use inclusions, advisory access, and platform resources responsibly.</p>
