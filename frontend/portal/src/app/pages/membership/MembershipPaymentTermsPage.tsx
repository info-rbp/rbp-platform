...
export function MembershipPaymentTermsPage() {
  return (
      ...
      <main className="py-16 sm:py-20">
        <div className="mx-auto w-full max-w-5xl px-4 sm:px-6 lg:px-8">
          <div className="rounded-2xl border border-slate-200 bg-white p-8 sm:p-10 shadow-sm">
            ...
            <h1 className="text-3xl font-black tracking-tight text-slate-900 sm:text-4xl">Membership Payment Terms</h1>
            <p className="mt-4 max-w-3xl text-slate-600">Placeholder public payment terms page for billing cycles, renewals, and cancellation timing (no payment processing implemented).</p>
            ...
            <section className="mt-8">
              ...
              <div className="mt-3 flex flex-wrap gap-4">
                ...
                <Link to="/membership/frequently-asked-questions" className="text-sm font-semibold text-blue-700 hover:text-blue-800 hover:underline">FAQ</Link>
              </div>
            </section>
          </div>
        </div>
