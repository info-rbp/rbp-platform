      ...
      <main className="py-16 sm:py-20">
        <div className="mx-auto w-full max-w-5xl px-4 sm:px-6 lg:px-8">
          <div className="rounded-2xl border border-slate-200 bg-white p-8 sm:p-10 shadow-sm">
            ...
            <h1 className="text-3xl font-black tracking-tight text-slate-900 sm:text-4xl">Membership Inclusions</h1>
            <p className="mt-4 max-w-3xl text-slate-600">Placeholder list of tools, resources, advisory support, and member benefits included in the public membership program.</p>
            ...
            <section className="mt-8">
              ...
              <div className="mt-3 flex flex-wrap gap-4">
                ...
                <Link to="/membership/pricing" className="text-sm font-semibold text-blue-700 hover:text-blue-800 hover:underline">Pricing</Link>
                <Link to="/membership/payment-terms" className="text-sm font-semibold text-blue-700 hover:text-blue-800 hover:underline">Payment Terms</Link>
              </div>
            </section>
            <Link to="/membership/pricing" className="mt-8 inline-flex items-center rounded-xl bg-blue-700 px-5 py-2.5 text-sm font-bold text-white hover:bg-blue-800 transition-colors">
              Compare Pricing
            </Link>
          </div>
        </div>
