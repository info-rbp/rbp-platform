...
check_absent_path "sites" "Bench sites runtime directory"
...
check_absent_glob "./*/node_modules" "Nested node_modules directories"
check_absent_glob "./*/dist" "Nested dist directories"
check_absent_glob "./*/build" "Nested build directories"
check_absent_glob "./*/logs" "Nested logs directories"
check_absent_glob "./*/.env" "Local .env files"
check_absent_glob "./*/.env.local" "Local .env.local files"
check_absent_glob "./*/.env.production" "Local .env.production files"
check_absent_glob "./*/__pycache__" "Python __pycache__ directories"

if git ls-files | grep -E '(^|/)(node_modules|dist|build|logs|sites)(/|$)'; then
